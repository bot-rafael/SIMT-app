...
export default function PelatihanUnggulan() {
  return (
    <div className="flex flex-col">
      <h1 className="text-5xl text-center text-black font-bold mt-10">Pelatihan <span className="text-blue-500">Unggulan</span></h1>
      ...
      <div className="flex flex-col items-center">
        ...
        <h1 className="text-4xl font-light text-blue-500 mt-20">Dipercaya Oleh Perusahaan Terkemuka</h1>
